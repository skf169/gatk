...
public final class MetricsUtils {
    ...
    /**
     * Write a {@link MetricsFile} to the given path, can be any destination supported by {@link IOUtils#openOutputStream(String)}
    ...
    public static void saveMetrics(final MetricsFile<?, ?> metricsFile, String metricsOutputPath) {
        try(PrintWriter out = new PrintWriter(IOUtils.openOutputStream(IOUtils.getPath(metricsOutputPath)))) {

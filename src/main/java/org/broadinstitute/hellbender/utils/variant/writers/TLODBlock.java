...
final class TLODBlock extends GVCFBlock {
    ...
    private int partitionPrecision = 1;

    /**
     * Create a new HomRefBlock
     *
     * @param startingVC the VariantContext that starts this band (for starting position information)
     * @param lowerLODBoundAsBinnedInt the lower LOD Bound (inclusive) to use in this band, represented as a binned integer
     * @param upperLODBoundAsBinnedInt the upper LOD Bound (exclusive) to use in this band
     */
    TLODBlock(final VariantContext startingVC, final int lowerLODBoundAsBinnedInt, final int upperLODBoundAsBinnedInt) {
